...
@Entity
public class Escritorio extends GenericDomain {
	
	@Id
	@SequenceGenerator(name = "idEscritorio", sequenceName = "idEscritorio", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "idEscritorio")
